...
function ProductList({ onHomeClick }) {
  ...
  // Track added products to disable button
  ...
  const handleHome = (e) => { e.preventDefault(); onHomeClick(); };
  ...
  const styleObjUl = { display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '500px' };
